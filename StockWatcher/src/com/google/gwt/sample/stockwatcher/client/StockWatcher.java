...
public class StockWatcher implements EntryPoint {
	...
	private VerticalPanel mainPanel = new VerticalPanel();        // lays the stocksFlexTable,addPanel, and lastUpdatedLabel vertially
	private FlexTable stocksFlexTable = new FlexTable();          // shows the stocks
	private HorizontalPanel addPanel = new HorizontalPanel();     // for inputting and adding the stocks
	//these two are laid horizonatally in the addPanel
	private TextBox newSymbolTextBox = new TextBox();  
	private Button addStockButton = new Button("Add");
	private ArrayList<String> stocks = new ArrayList<String>();
	
	private Label lastUpdatedLabel = new Label();       // timestamp of last updated
